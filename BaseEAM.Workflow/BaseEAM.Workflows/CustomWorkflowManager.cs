...
using BaseEAM.Workflows.CustomInstanceStore;
using log4net;
using System;
...
{
    public static class CustomWorkflowManager
    {
        static CustomWorkflowManager()
        {
        }
        private static readonly ILog logger = LogManager.GetLogger(typeof(CustomWorkflowManager));
