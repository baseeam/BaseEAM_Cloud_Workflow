...
namespace BaseEAM.WorkflowService
{
    public class AutoFacConfig
    {
        public static IContainer Initialize(HttpConfiguration config)
        {
            ...
            var workflowBuilder = WorkflowServiceEngine.Instance.WorkflowBuilder;
            RegisterServices(workflowBuilder);

            //build WorkflowContainerManager, then we can get IContainer in Http Request life cycle
            WorkflowServiceEngine.Instance.Build();

            IContainer container = WorkflowServiceEngine.Instance.WorkflowContainerManager.Container;
        ...
        private static void RegisterServices(ContainerBuilder builder)
        {
            ...
            //work context
            builder.RegisterType<WorkflowServiceWorkContext>().As<IWorkContext>().InstancePerLifetimeScope();
            ...
            //WorkflowService use Log4net to log to file
